...
public class TextClient
        extends JFrame
        implements IProcessadorMensagem {

    private CamadaSIP sipLayer;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CamadaSIP sipLayer = new CamadaSIP(username, ip, port);
            TextClient tc = new TextClient(sipLayer);
            sipLayer.setProcessadorMensagem(tc);
    ...
    public TextClient(CamadaSIP sip) {
        super();
        sipLayer = sip;
        initWindow();
        String from = "sip:" + sip.getUsuario() + "@" + sip.getHost() + ":" + sip.getPort();
